...
explosion_sound = pygame.mixer.Sound("Explo.wav")
move_sound = pygame.mixer.Sound("Move.wav  ")
war = pygame.mixer.music.load("war.mp3")
pygame.mixer.music.set_volume(0.9)

pygame.display.set_caption('Troko')

icon = pygame.image.load("tank2.jpg").convert()
icon2 = pygame.image.load("tank9.jpg").convert()
icon3 = pygame.image.load("win.jpg").convert()
icon4 = pygame.image.load("loose.jpg").convert()
...
def tank(x, y, turPos):
    ...
    pygame.draw.circle(gameDisplay, yellow, (x - 10, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, black, (x - 5, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, yellow, (x, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, black, (x + 5, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, yellow, (x + 10, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, black, (x + 15, y + 20), wheelWidth)
...
def enemy_tank(x, y, turPos):
    ...
    pygame.draw.circle(gameDisplay, yellow, (x + 5, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, black, (x + 10, y + 20), wheelWidth)
    pygame.draw.circle(gameDisplay, yellow, (x + 15, y + 20), wheelWidth)
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.blit(icon2, [0, 0])
        message_to_screen("Welcome to TROKO!", gray, -120, size="large")
...
def you_win():
    ...
    while you_win:
        ...
        gameDisplay.blit(icon3, [0, 0])
        message_to_screen("You Won",white, -100, size="large")
        message_to_screen("well this is what you have done", red, -30)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LEFT:
                    ...
                    damage = e_fireShell(enemy_gun, enemyTankX, enemyTankY, 8, 50, xlocation, barrier_width, randomHeight,
                                mainTankX, mainTankY)
